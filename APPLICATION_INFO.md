...
This is handled by your window manager (GNOME, KDE, etc.). The app requests
native decorations. If still not showing:
...
**Last Updated**: March 2024 **Version**: 0.1.0 **License**: MIT - Open Source
