...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, onRefresh }) => {
  return (
    <div style={{ 
      ...
      <button 
        style={{ ...btnStyle, background: currentView === "library" ? "rgba(255, 255, 255, 0.1)" : "transparent" }}
      ...
      <button 
        style={{ ...btnStyle, background: currentView === "discover" ? "rgba(255, 255, 255, 0.1)" : "transparent" }}
      ...
      <button 
        style={{ ...btnStyle, background: currentView === "settings" ? "rgba(255, 255, 255, 0.1)" : "transparent" }}
